...
//     {
//         if (!file)
//             perror("CAutoFile::read: file handle is NULL");
//             //throw std::ios_base::failure("CAutoFile::read: file handle is NULL");
//         if (fread(pch, 1, nSize, file) != nSize)
//             perror("CAutoFile::read: end of file");
...
//     {
//         if (!file)
//             perror("CAutoFile::write: file handle is NULL");
//             //throw std::ios_base::failure("CAutoFile::write: file handle is NULL");
//         if (fwrite(pch, 1, nSize, file) != nSize)
//             perror("CAutoFile::write: write failed");
...
//         // Serialize to this stream
//         if (!file)
//             perror("CAutoFile::operator<<: file handle is NULL");
...
//         if (read == 0) {
//             perror("CBufferedFile::Fill: end of file");
...
//             perror("Read attempted past buffer limit");
//             //throw std::ios_base::failure("Read attempted past buffer limit");
//         if (nSize + nRewind > vchBuf.size())
//             perror("Read larger than buffer size");
